...
Provisions the static frontend infrastructure for the dev environment. Creates an S3 bucket configured as a website origin and a CloudFront distribution with an ACM certificate (pre-provisioned, looked up by domain name).
